...
data1 = pd.read_csv("2017_overall_RankingEngg.csv")
data2 = pd.read_csv("2018_overall_RankingEngg.csv")
data3 = pd.read_csv("2019_overall_RankingEngg.csv")
data4 = pd.read_csv("2020_overall_RankingEngg.csv")
...
results = pd.read_csv("results_of_overall_final.csv")
